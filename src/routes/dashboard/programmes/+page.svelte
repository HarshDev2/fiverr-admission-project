		...
		<Modal bind:open={editStudentOpened} size="xs" autoclose={false} class="w-full">
			<div class="flex flex-col space-y-6" action="#">
				...
				<Label class="space-y-2">
					<span>Gender</span>
					<Select
						bind:value={newProgrammeDetails.gender}
				...
				<Label class="space-y-2">
					...
					<Input
						bind:value={newProgrammeDetails.index}
						color={'green'}
						type="text"
						name="Index Number"
				...
				<Label class="space-y-2">
					<span>Aggregate</span>
					<Input
						bind:value={newProgrammeDetails.aggregate}
						color={'green'}
						type="text"
						name="aggregate"
						placeholder="E.g. xx"
				...
				<Label class="space-y-2">
					<span>Programme</span>
					<Input
						bind:value={newProgrammeDetails.programme}
						color={'green'}
						type="text"
						name="programme"
						placeholder="E.g. General Arts"
				...
				<Label class="space-y-2">
					<span>Track</span>
					<Input
						bind:value={newProgrammeDetails.track}
						color={'green'}
						type="text"
						name="track"
				...
				<Label class="space-y-2">
					<span>Status</span>
					<Input
						bind:value={newProgrammeDetails.status}
						color={'green'}
						type="text"
						name="status"
						placeholder="E.g. Day"
